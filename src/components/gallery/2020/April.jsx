...
import april2020csv from '../../../assets/data/april2020.csv?url';
import ma2010returnratescsv from '../../../assets/data/MA_2010_return_rates.csv?url';
...
const April = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const existingMap = document.getElementById('aprilMap');
      if (existingMap) {
