...
import may2020__shelters from '../../../assets/data/may2020__shelters.csv?url';
...
const May = () => {
  ...
  useEffect(() => {
    ...
    d3.csv(may2020__shelters).then((response) => {
      ...
      response.forEach((row) => {
        const entry = { 
          type: 'Feature', 
          properties: { Name: row['Facility Name'], Contact: row.Contact }, 
      ...
      const existingMap = document.getElementById('mayMap');
      if (existingMap) {
